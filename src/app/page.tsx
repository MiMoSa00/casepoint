...
export default function Home() {
  return (
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap"> Capture your best and favorite memories with your own, {' '} <span className="font-semibold">unique and exceptional</span> phone case. CasePoint enables you to protect your precious memories, not just your phone case.
              </p>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  ...
                  <p><span className="font-semibold">1.320</span> happy customers</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20 ">
              ...
              <div className="text-lg leading-8 ">
                <p>
                  "The case feels durable and I got complimented on the design.Had the case for two month now and {' '}<span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before started fading into blueish color after a couple weeks. Love it."
                </p>

              </div>
              <div className="flex gap-4 mt-2 ">
                <img src="/users/user-2.png" className="rounded-full h-12 w-12 object-cover" alt="user" />
                <div className="flex flex-col ">
                  <p className="font-semibold"> Marian</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20 ">
              ...
              <div className="text-lg leading-8 ">
                <p>
                  "I usually keep my phone together with my keys together with my keys in my pocket, which led to some severe scratchmarks on my previous phone cases. This one, besides a barely noticable scratch on the corner, {' '}<span className="p-0.5 bg-slate-800 text-white">looks brand new after about half a year</span>. I love it."
                </p>

              </div>
              <div className="flex gap-4 mt-2 ">
                <img src="/users/user-3.png" className="rounded-full h-12 w-12 object-cover" alt="user" />
                <div className="flex flex-col ">
    ...
    <div className="mb-12 px-6 lg:px-8">
      ...
      <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">Upload your photo and get <span className="relative px-2 bg-green-600 text-white">your own phone case </span> {' '} now</h2>
      </div>
    </div>

    <div className="mx-auto max-w-6xl px-6 lgg:px-8 ">
      ...
      <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rouned-2xl">
